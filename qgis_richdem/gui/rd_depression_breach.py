...
class RdDepressionBreach(QgsProcessingAlgorithm):
    """
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        breached = self.parameterAsOutputLayer(
            parameters, self.OUTPUT, context
        )

        dem_array = rd.LoadGDAL(dem.source())
        rd.BreachDepressions(dem_array, in_place=True)
        rd.SaveGDAL(breached, dem_array)
